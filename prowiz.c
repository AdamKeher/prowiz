...
int main ( int ac , char **av )
{
  ...
  if ( ac < 4 )
  {
    fprintf ( stderr, "\n\n-<([ Pro-Wizard v1.70a (demoscene.au modified) ])>-\n\n" );
  ...
  for ( PW_i=0 ; PW_i<(PW_in_size-MINIMAL_FILE_LENGHT) ; PW_i+=1 )
  {
	 ...
	 */
           ...
           (in_data[PW_i+3] == '!') )
      {
        if ( testPM() != BAD )
        {
          if(Do_Rip==GOOD)Rip_PM();
          if(Do_Depack==GOOD)Depack_PM();
        }
      }
      /* Treasure Patterns ?*/
      ...
      */
           ...
           (in_data[PW_i+3] == 0x0D)))
      {
        ...
        {
          Current_Is_Module=BAD;if(Do_Rip==GOOD)Rip_SpecialCruncherData( "StoneCracker 2.92 Data Cruncher" , 12 , STC292data );
        }
      }
      /* "1AM" data cruncher */
      if ( (in_data[PW_i]   == '1') &&
           ...
           (in_data[PW_i+2] == 'M') )
      {
        ...
        {
          Current_Is_Module=BAD;if(Do_Rip==GOOD)Rip_SpecialCruncherData( "Amnesty Design (1AM) Data Cruncher" , 16 , AmnestyDesign1 );
        }
      }
      /* "2AM" data cruncher */
      if ( (in_data[PW_i]   == '2') &&
           ...
           (in_data[PW_i+2] == 'M') )
      {
        if ( testSpecialCruncherData ( 8, 4 ) != BAD )
        {
          Current_Is_Module=BAD;if(Do_Rip==GOOD)Rip_SpecialCruncherData( "Amnesty Design (2AM) Data Cruncher" , 12 , AmnestyDesign2 );
        }
      }
#endif
           ...
           (in_data[PW_i+3] == 'N') )
      {
        ...
        {
          if(Do_Rip==GOOD)Rip_MOD(in_data[PW_i]-0x30);
        }
      }
	    ...
	    (in_data[PW_i+3] == 'H') )
      {
        ...
        {
          if(Do_Rip==GOOD)Rip_MOD((in_data[PW_i]-0x30)*10+in_data[PW_i+1]-0x30);
        }
      }
#ifdef INCLUDEALL
      /* =SB= data cruncher */
           ...
           (in_data[PW_i+3] == 0x3D) )
      {
        if ( testSpecialCruncherData ( 8, 4 ) != BAD )
        {
          Current_Is_Module=BAD;if(Do_Rip==GOOD)Rip_SpecialCruncherData( "=SB= Data Cruncher" , 12 , SB_DataCruncher );
        }
      }
           ...
           (in_data[PW_i+3] == 0x0B) )
      {
        if ( testB9AB () != BAD )
        {
          Current_Is_Module=BAD;if(Do_Rip==GOOD)Rip_SpecialCruncherData( "B9AB Data Cruncher" , 274, B9AB );
        }
      }
           ...
           (in_data[PW_i+3] == 0x2D) )
      {
        ...
        {
          Current_Is_Module=BAD;if(Do_Rip==GOOD)Rip_SpecialCruncherData( "-CJ- Data Cruncher" , 0 , CJ_DataCruncher );
        }
      }
           ...
           (in_data[PW_i+3] == 0x2D) )
      {
        if ( testSkizzo() != BAD )
        {
          if(Do_Rip==GOOD)Rip_Skizzo();
          if(Do_Depack==GOOD)Depack_Skizzo();
        }
      }
         ...
         (in_data[PW_i+15] == 0xFA) )
      {
        ...
        {
          Current_Is_Module=BAD;if(Do_Rip==GOOD)Rip_MaxPacker12();
        }
      }
#endif
      ...
      if ( in_data[PW_i] == 0x3c )
      {
        if ( testXANN() != BAD )
        {
          if(Do_Rip==GOOD)Rip_XANN();
          if(Do_Depack==GOOD)Depack_XANN();
        }
      }
      ...
      if ( testMP_noID() != BAD )
      {
        if(Do_Rip==GOOD)Rip_MP_noID();
        if(Do_Depack==GOOD)Depack_MP();
      }

      /* Digital Illusion */
      if ( testDI() != BAD )
      {
        if(Do_Rip==GOOD)Rip_DI();
        if(Do_Depack==GOOD)Depack_DI();
      }
      ...
      */
      ...
      if ( testEUREKA() != BAD )
      {
        if(Do_Rip==GOOD)Rip_EUREKA();
        if(Do_Depack==GOOD)Depack_EUREKA();
      }

      /* The player 5.0a ? */
      if ( testP50A() != BAD )
      {
        if(Do_Rip==GOOD)Rip_P50A();
        if(Do_Depack==GOOD)Depack_P50A();
      }
      ...
      if ( testPP10() != BAD )
      {
        if(Do_Rip==GOOD)Rip_PP10();
        if(Do_Depack==GOOD)Depack_PP10();
      }
      ...
      {
        if(Do_Rip==GOOD)Rip_Noisepacker2();
        if(Do_Depack==GOOD)Depack_Noisepacker2();
      }

      /* Noise Packer v1 */
      if ( testNoisepacker1() != BAD )
      {
        if(Do_Rip==GOOD)Rip_Noisepacker1();
        if(Do_Depack==GOOD)Depack_Noisepacker1();
      }

      /* Noise Packer v3 */
      if ( testNoisepacker3() != BAD )
      {
        if(Do_Rip==GOOD)Rip_Noisepacker3();
        if(Do_Depack==GOOD)Depack_Noisepacker3();
      }

      /* Promizer 0.1 */
      if ( testPM01() != BAD )
      {
        if(Do_Rip==GOOD)Rip_PM01();
        if(Do_Depack==GOOD)Depack_PM01();
      }

      /* ProPacker 2.1 */
      if ( testPP21() != BAD )
      {
        if(Do_Rip==GOOD)Rip_PP21();
        if(Do_Depack==GOOD)Depack_PP21();
      }

      /* ProPacker 3.0 */
      if ( testPP30() != BAD )
      {
        if(Do_Rip==GOOD)Rip_PP30();
        if(Do_Depack==GOOD)Depack_PP30();
      }

      /* StartTrekker pack */
      if ( testSTARPACK() != BAD )
      {
        if(Do_Rip==GOOD)Rip_STARPACK();
        if(Do_Depack==GOOD)Depack_STARPACK();
      }

      /* Zen packer */
      if ( testZEN() != BAD )
      {
        if(Do_Rip==GOOD)Rip_ZEN();
        if(Do_Depack==GOOD)Depack_ZEN();
      }

      /* Unic tracker v1 ? */
      if ( testUNIC_withemptyID() != BAD )
      {
        if(Do_Rip==GOOD)Rip_UNIC_withID();
        if(Do_Depack==GOOD)Depack_UNIC();
      }

      /* Unic tracker v1 ? */
      if ( testUNIC_noID() != BAD )
      {
        if(Do_Rip==GOOD)Rip_UNIC_noID();
        if(Do_Depack==GOOD)Depack_UNIC();
      }
      ...
      if ( testUNIC2() != BAD )
      {
        if(Do_Rip==GOOD)Rip_UNIC2();
        if(Do_Depack==GOOD)Depack_UNIC2();
      }

      /* Game Music Creator ? */
      if ( testGMC() != BAD )
      {
        if(Do_Rip==GOOD)Rip_GMC();
        if(Do_Depack==GOOD)Depack_GMC();
      }

      /* Heatseeker ? */
      if ( testHEATSEEKER() != BAD )
      {
        if(Do_Rip==GOOD)Rip_HEATSEEKER();
        if(Do_Depack==GOOD)Depack_HEATSEEKER();
      }

      /* SoundTracker (15 smp) */
      if ( testSoundTracker() != BAD )
      {
        if(Do_Rip==GOOD)Rip_SoundTracker();
      }

      /* The Dark Demon (group name) format */
      if ( testTheDarkDemon() != BAD )
      {
        if(Do_Rip==GOOD)Rip_TheDarkDemon();
        if(Do_Depack==GOOD)Depack_TheDarkDemon();
      }

      /* Newtron */
      if ( testNewtron() != BAD )
      {
        if(Do_Rip==GOOD)Rip_Newtron();
        if(Do_Depack==GOOD)Depack_Newtron();
      }

      /* Newtron Old */
      if ( testNewtronOld() != BAD )
      {
        if(Do_Rip==GOOD)Rip_NewtronOld();
        if(Do_Depack==GOOD)Depack_NewtronOld();
      }

      /* Titanics Player ? */
      if ( testTitanicsPlayer() != BAD )
      {
        if(Do_Rip==GOOD)Rip_TitanicsPlayer();
        if(Do_Depack==GOOD)Depack_TitanicsPlayer();
      }
...
/*      if ( testSTRUGGLE() != BAD )
    ...
    switch ( in_data[PW_i] )
    {
      case 'A': /* ATN! another Imploder case */
             ...
             (in_data[PW_i+3] == '!') )
        {
          if ( testSpecialCruncherData ( 8, 4 ) != BAD )
          {
            Current_Is_Module=BAD;if(Do_Rip==GOOD)Rip_SpecialCruncherData( "Imploder data" , 50 , IMP );
          }
        }
#endif
	/* AMOS Music bank "AmBk" */
             ...
             (in_data[PW_i+3] == 'k') )
        {
          if ( testAmBk() != BAD )
          {
            if(Do_Rip==GOOD)Rip_AmBk();
            if(Do_Depack==GOOD)Depack_AmBk();
          }
        }
	/* Sidmon v1 */
             ...
             (in_data[PW_i+21] == 0x20) )
        {
          ...
          {
            Current_Is_Module=BAD;if(Do_Rip==GOOD)Rip_TimeCruncher17();
          }
        }
             ...
             (in_data[PW_i+3] == '5') )
        {
          if ( testSpecialCruncherData ( 8, 4 ) != BAD )
          {
            Current_Is_Module=BAD;if(Do_Rip==GOOD)Rip_SpecialCruncherData( "IAM Packer 1.0 (ATM5) data" , 12 , ICE );
          }
        }
             ...
             (in_data[PW_i+3] == 'M') )
        {
          if ( testSpecialCruncherData ( 8, 4 ) != BAD )
          {
            Current_Is_Module=BAD;if(Do_Rip==GOOD)Rip_SpecialCruncherData( "Atomik Packer (ATOM) data" , 12 , AtomikPackerData );
          }
        }
             ...
             (in_data[PW_i+3] == '3') )
        {
          if ( testSpecialCruncherData ( 8, 4 ) != BAD )
          {
            Current_Is_Module=BAD;if(Do_Rip==GOOD)Rip_SpecialCruncherData( "Atomik Packer (ATM3) data" , 12 , AtomikPackerData );
          }
        }
             ...
             (in_data[PW_i+3] == '!') )
        {
          if ( testSpecialCruncherData ( 8, 4 ) != BAD )
          {
            Current_Is_Module=BAD;if(Do_Rip==GOOD)Rip_SpecialCruncherData( "Automation Packer v5.01 (data)" , 0 , AutomationPackerData );
          }
        }
        /* Syncro Packer 4.6 */
        if ( (in_data[PW_i+1]  == 0xFA ) &&
             ...
             (in_data[PW_i+15] == 0x20 ) )
        {
          ...
          {
            Current_Is_Module=BAD;if(Do_Rip==GOOD)Rip_SyncroPacker();
          }
        }
        /* Tetrapack 1.02 */
        if ( (in_data[PW_i+1]  == 0xFA ) &&
             ...
             (in_data[PW_i+19] == 0xC9 ) )
        {
          ...
          {
            if(Do_Rip==GOOD)Rip_Tetrapack102();
          }
        }
        /* Tetrapack 1.01 */
        if ( (in_data[PW_i+1]  == 0xFA ) &&
             ...
             (in_data[PW_i+19] == 0xC9 ) )
        {
          ...
          {
            if(Do_Rip==GOOD)Rip_Tetrapack101();
          }
        }
        /* "ArcD" data cruncher */
        if ( (in_data[PW_i+1]  == 'r') &&
             ...
             (in_data[PW_i+3]  == 'D'))
        {
          ...
          {
            Current_Is_Module=BAD;if(Do_Rip==GOOD)Rip_SpecialCruncherData( "ArcD data Cruncher" , 0 , arcD );
          }
        }
        /* HQC Cruncher 2.0 */
        if ( (in_data[PW_i+1]  == 0xFA ) &&
             ...
             (in_data[PW_i+15] == 0x89 ) )
        {
          ...
          {
            if(Do_Rip==GOOD)Rip_HQCCruncher2();
          }
        }
        /* ByteKillerPro 1.0 */
        if ( (in_data[PW_i+1]  == 0xFA) &&
             ...
             (in_data[PW_i+21] == 0x28) )
        {
          ...
          {
            if(Do_Rip==GOOD)Rip_bytekillerpro10();
          }
        }
             ...
             (in_data[PW_i+9] == 0x7c) )
        {
          ...
          {
            Current_Is_Module=BAD;if(Do_Rip==GOOD)Rip_BKCloneFLT();
          }
        }
             ...
             (in_data[PW_i+17] == 0x60) )
        {
          if ( testBKClone5() != BAD )
          {
            Current_Is_Module=BAD;if(Do_Rip==GOOD)Rip_BKClone5();
          }
        }
	/* Ace? (data cruncher) */
        if ( (in_data[PW_i+1] == 'c') &&
             ...
             (in_data[PW_i+3] == '?') )
        {
          if ( testSpecialCruncherData ( 4, 8 ) != BAD )
          {
            Current_Is_Module=BAD;if(Do_Rip==GOOD)Rip_SpecialCruncherData( "(Ace?) Data Cruncher" , 0 , ACECruncherData );
          }
        }
#endif
        /* Delta Music 1 */
      ...
      case 'B': /* BTB6 */
             ...
             (in_data[PW_i+3] == '6') )
        {
          ...
          {
            Current_Is_Module=BAD;if(Do_Rip==GOOD)Rip_ByteKiller();
          }
             ...
             (in_data[PW_i+3] == '2') )
        {
          ...
          {
            Current_Is_Module=BAD;if(Do_Rip==GOOD)Rip_SpecialCruncherData( "(BHC2) Data Cruncher" , 0x3C , BHC2CruncherData );
          }
        }
        /* BHC3 (data cruncher) */
        if ( (in_data[PW_i+1] == 'H') &&
             ...
             (in_data[PW_i+3] == '3') )
        {
          if ( testSpecialCruncherData ( 8, 4 ) != BAD )
          {
            Current_Is_Module=BAD;if(Do_Rip==GOOD)Rip_SpecialCruncherData( "(BHC3) Data Cruncher" , 0xC8 , BHC3CruncherData );
          }
        }
#endif
        /* "BeEp" Jam Cracker */
             ...
             (in_data[PW_i+3] == '!') )
        {
          if ( testBNR() != BAD )
          {
            if(Do_Rip==GOOD)Rip_BNR();
            if(Do_Depack==GOOD)Depack_BNR();
          }
        }
        break;
      ...
      /* CPLX_TP3 ?!? */
             ...
             (in_data[PW_i+7] == '3') )
        {
          if ( testTP3() != BAD )
          {
            if(Do_Rip==GOOD)Rip_TP3();
            if(Do_Depack==GOOD)Depack_TP3();
          }
        }
#ifdef INCLUDEALL
        /* CrM2 | Crm2 | CrM! */
              ...
              (in_data[PW_i+3] == '!')) )
        {
          ...
          {
            Current_Is_Module=BAD;if(Do_Rip==GOOD)Rip_SpecialCruncherData( "Crunchmania / Normal data" , 14 , CRM1 );
          }
        }
             ...
             (in_data[PW_i+3] == 'D') )
        {
          if ( testCRND() != BAD )
          {
            Current_Is_Module=BAD;if(Do_Rip==GOOD)Rip_SpecialCruncherData( "CRND data cruncher" , 20 , CRND );
          }
        }
	/* Defjam Cruncher 3.2 */
        if ( (in_data[PW_i+1] == 0xFA) &&
             ...
             ((in_data[PW_i+6] == 0x00) || (in_data[PW_i+6] == 0x4E)))
        {
          if ( testDefjam32() != BAD )
          {
            Current_Is_Module=BAD;if(Do_Rip==GOOD)Rip_Defjam32();
          }
        }
#endif
        break;
      ...
      case 'D': /* 0x44 */
	     ...
	     (in_data[PW_i+3] == 'I') )
        {
          ...
          {
            if(Do_Rip==GOOD)Rip_DigiBooster17();
          }
        }
        break;
      ...
      case 'E': /* 0x45 */
             ...
             (in_data[PW_i+3] == 'D') )
        {
          ...
          {
            if(Do_Rip==GOOD)Rip_QuadraComposer();
      ...
      case 'F': /* 0x46 */
             ...
             (in_data[PW_i+3] == 'M') )
        {
          if ( testFC_M() != BAD )
          {
            if(Do_Rip==GOOD)Rip_FC_M();
            if(Do_Depack==GOOD)Depack_FC_M();
          }
        }
             ...
             (in_data[PW_i+3] == 'M') )
        {
          if ( testIFF() != BAD )
          {
            Current_Is_Module=BAD;if(Do_Rip==GOOD)Rip_IFF();
          }
        }
             ...
             (in_data[PW_i+3] == 'O') )
        {
          ...
          {
            if(Do_Rip==GOOD)Rip_BSIFutureComposer();
          }
        }
             ...
             (in_data[PW_i+3] == 'k') )
        {
          if ( testNFH() != BAD )
          {
            if(Do_Rip==GOOD)Rip_NFH();
            if(Do_Depack==GOOD)Depack_NFH();
          }
        }
             ...
             (in_data[PW_i+3] == 'T') )
        {
          ...
          {
            if(Do_Rip==GOOD)Rip_StoneArtsPlayer();
  	        if(Do_Depack==GOOD)Depack_StoneArtsPlayer();
          }
        }
#ifdef INCLUDEALL
             ...
             (in_data[PW_i+3] == 'E') )
        {
          if ( testSpecialCruncherData ( 4, 8 ) != BAD )
          {
            Current_Is_Module=BAD;if(Do_Rip==GOOD)Rip_SpecialCruncherData( "FIRE (RNC Clone) data Cruncher" , 0 , FIRE );
          }
        }
#endif
        break;
      ...
      case 'G': /* 0x47 */
             ...
             (in_data[PW_i+15] == 0xC1 ) )
        {
          ...
          {
            if(Do_Rip==GOOD)Rip_MegaCruncher();
          }
        }
             ...
             (in_data[PW_i+143]== 0x20 ) )
        {
          ...
          {
            if(Do_Rip==GOOD)Rip_DoubleAction10();
          }
        }
#endif
	/* GPMO (crunch player ?)*/
           ...
           (in_data[PW_i+3] == 'O') )
        {
          if ( testGPMO() != BAD )
          {
            if(Do_Rip==GOOD)Rip_GPMO();
            if(Do_Depack==GOOD)Depack_GPMO();
          }
        }
	...
	/* Gnu player */
           ...
           (in_data[PW_i+3] == 'l') )
        {
          ...
          {
            if(Do_Rip==GOOD)Rip_GnuPlayer();
            if(Do_Depack==GOOD)Depack_GnuPlayer();
          }
        }
      ...
      case 'H': /* 0x48 */
           ...
           (in_data[PW_i+3] == '!') )
        {
          if ( testHRT() != BAD )
          {
            if(Do_Rip==GOOD)Rip_HRT();
            if(Do_Depack==GOOD)Depack_HRT();
          }
        }
             ...
             (in_data[PW_i+15] == 0xC9) )
        {
          ...
          {
            if(Do_Rip==GOOD)Rip_MasterCruncher30addr();
          }
        }
             ...
             (in_data[PW_i+15] == 0x78) )
        {
          ...
          {
            Current_Is_Module=BAD;if(Do_Rip==GOOD)Rip_Powerpacker4lib();
          }
        }
        /* StoneCracker 2.70 */
        if ( (in_data[PW_i+1]  == 0xE7) &&
             ...
             (in_data[PW_i+15] == 0x00) )
        {
          ...
          {
            Current_Is_Module=BAD;if(Do_Rip==GOOD)Rip_StoneCracker270();
          }
        }
             ...
             (in_data[PW_i+15] == 0xF9) )
        {
          ...
          {
            Current_Is_Module=BAD;if(Do_Rip==GOOD)Rip_ByteKiller30();
          }
        }
             ...
             (in_data[PW_i+15] == 0x98) )
        {
          ...
          {
            Current_Is_Module=BAD;if(Do_Rip==GOOD)Rip_Powerpacker23();
          }
        }
             ...
             (in_data[PW_i+15] == 0xC8) )
        {
          ...
          {
            Current_Is_Module=BAD;if(Do_Rip==GOOD)Rip_Powerpacker30();
          }
        }
             ...
             (in_data[PW_i+15] == 0xC8) )
        {
          ...
          {
            Current_Is_Module=BAD;if(Do_Rip==GOOD)Rip_Powerpacker40();
          }
        }
             ...
             (in_data[PW_i+15] == 0xFA) )
        {
          ...
          {
            Current_Is_Module=BAD;if(Do_Rip==GOOD)Rip_SuperCruncher27();
          }
        }
           ...
           (in_data[PW_i+31] == 0xCA) )
        {
          ...
          {
            if(Do_Rip==GOOD)Rip_CrunchmaniaAddr();
          }
        }
	    ...
	    (in_data[PW_i+15] == 0x7A) )
        {
          ...
          {
            if(Do_Rip==GOOD)Rip_CrunchmaniaSimple();
          }
        }
             ...
             (in_data[PW_i+15] == 0xC0) )
        {
          ...
          {
            Current_Is_Module=BAD;if(Do_Rip==GOOD)Rip_RelokIt10();
          }
        }
             ...
             (in_data[PW_i+11] == 0xC0) )
        {
          ...
          {
            if(Do_Rip==GOOD)Rip_MegaCruncherObj();
          }
        }
             ...
             (in_data[PW_i+11] == 0x7A) )
        {
          ...
          {
            if(Do_Rip==GOOD)Rip_TurboSqueezer61();
          }
        }
             ...
             (in_data[PW_i+15] == 0x00) )
        {
          ...
          {
            if(Do_Rip==GOOD)Rip_Dragpack252();
          }
        }
        /* DragPack 1.00 */
        if ( (in_data[PW_i+1]  == 0xE7) &&
             ...
             (in_data[PW_i+15] == 0x00) )
        {
          ...
          {
            if(Do_Rip==GOOD)Rip_Dragpack100();
          }
        }
        /* GNU Packer 1.2 */
        if ( (in_data[PW_i+1]  == 0xE7) &&
             ...
             (in_data[PW_i+15] == 0x0C) )
        {
          ...
          {
            if(Do_Rip==GOOD)Rip_GNUPacker12();
          }
        }
#endif
        /* "HVL" - Hively tracker */
      ...
      case 'I': /* 0x48 */
             ...
             (in_data[PW_i+3] == '!') )
        {
          if ( testSpecialCruncherData ( 4, 8 ) != BAD )
          {
            Current_Is_Module=BAD;if(Do_Rip==GOOD)Rip_SpecialCruncherData( "IAM Packer 1.0 (ICE!) data" , 0 , ICE );
          }
        }
             ...
             (in_data[PW_i+3] == '!') )
        {
          if ( testSpecialCruncherData ( 4, 8 ) != BAD )
          {
            Current_Is_Module=BAD;if(Do_Rip==GOOD)Rip_SpecialCruncherData( "Ice! Cruncher (data)" , 0 , ICE );
          }
        }
          /* "IMP!" */
        if ( (in_data[PW_i+1] == 'M') &&
             ...
             (in_data[PW_i+3] == '0') )
        {
          ...
          if ( testSTK26() != BAD )
          {
            if(Do_Rip==GOOD)Rip_STK26();
            if(Do_Depack==GOOD)Depack_STK26();
          }
        }
        break;
      ...
      case 'K': /* 0x4B */
             ...
             (in_data[PW_i+3] == 'S') )
        {
          if ( testKRIS() != BAD )
          {
            if(Do_Rip==GOOD)Rip_KRIS();
            if(Do_Depack==GOOD)Depack_KRIS();
          }
        }
#ifdef INCLUDEALL
             ...
             (in_data[PW_i+15] == 0x4A) )
        {
          if ( testTryIt101() != BAD )
          {
            Current_Is_Module=BAD;if(Do_Rip==GOOD)Rip_TryIt101();
          }
        }
#endif
        break;
      ...
      case 'L': /* 0x4C */
             ...
             (in_data[PW_i+3] == '!') )
        {
          if ( testSpecialCruncherData ( 8, 4 ) != BAD )
          {
            Current_Is_Module=BAD;if(Do_Rip==GOOD)Rip_SpecialCruncherData( "Automation 2.3r Data Cruncher" , 4 , LSDDataCruncher );
          }
        }
             ...
             (in_data[PW_i+3] == '!') )
        {
          if ( testSpecialCruncherData ( 8, 4 ) != BAD )
          {
            Current_Is_Module=BAD;if(Do_Rip==GOOD)Rip_SpecialCruncherData( "Jam Packer Data Cruncher" , 12 , JamDataCruncher );
          }
        }
#endif
        break;
      ...
      case 'M': /* 0x4D */
             ...
             (in_data[PW_i+3] == 'M') )
        {
          if ( testSpecialCruncherData ( 4, 8 ) != BAD )
          {
            Current_Is_Module=BAD;if(Do_Rip==GOOD)Rip_SpecialCruncherData( "MASM Data Cruncher" , 0 , MASMDataCruncher );
          }
        }
             ...
             (in_data[PW_i+3] == '.') )
        {
          ...
          {
            if(Do_Rip==GOOD)Rip_Noiserunner();
            if(Do_Depack==GOOD)Depack_Noiserunner();
          }

          /* Mosh packer ? */
          if ( testMOSH() != BAD )
          {
            if(Do_Rip==GOOD)Rip_MOSH();
            if(Do_Depack==GOOD)Depack_MOSH();
          }
          /* HCD-protector ? */
          if ( testHCD() != BAD )
          {
            if(Do_Rip==GOOD)Rip_HCD();
            if(Do_Depack==GOOD)Depack_HCD();
          }
        }
             ...
             (in_data[PW_i+3] == '0') )
        {
          ...
          if ( testFUZZAC() != BAD )
          {
            if(Do_Rip==GOOD)Rip_Fuzzac();
            if(Do_Depack==GOOD)Depack_Fuzzac();
          }
        }
             ...
             (in_data[PW_i+3] == 'X') )
        {
          ...
          if ( testTP2() != BAD )
          {
            if(Do_Rip==GOOD)Rip_TP2();
            if(Do_Depack==GOOD)Depack_TP2();
          }
          /* tracker packer v1 */
          if ( testTP1() != BAD )
          {
            if(Do_Rip==GOOD)Rip_TP1();
            if(Do_Depack==GOOD)Depack_TP1();
          }
        }
        ...
        if ( in_data[PW_i+1] == '.' )
        {
          ...
          if ( testKSM() != BAD )
          {
            if(Do_Rip==GOOD)Rip_KSM();
            if(Do_Depack==GOOD)Depack_KSM();
          }
        }
             ...
             (in_data[PW_i+3] == 'U') )
        {
          ...
          {
            if(Do_Rip==GOOD)Rip_NovoTrade();
            if(Do_Depack==GOOD)Depack_NovoTrade();
            continue;
          }
        }
             ...
             (in_data[PW_i+3] == '0') )
        {
          if ( testSpecialCruncherData ( 12, 8 ) != BAD )
          {
            Current_Is_Module=BAD;if(Do_Rip==GOOD)Rip_SpecialCruncherData( "Mental Image Packer" , 18 , MentalImage );
          }
        }
#endif
        break;
      ...
      case 'P': /* 0x50 */
             ...
             (in_data[PW_i+3] == 'A') )
        {
          ...
          {
            if(Do_Rip==GOOD)Rip_P30A();
            if(Do_Depack==GOOD)Depack_P30();
          }
        }
             ...
             (in_data[PW_i+3] == 'A') )
        {
          if ( testP40A() != BAD ) /* yep, same tests apply */
	      {
            if(Do_Rip==GOOD)Rip_P22A();
            if(Do_Depack==GOOD)Depack_P22();
          }
        }
             ...
             (in_data[PW_i+3] == 'A') )
        {
          if ( testP40A() != BAD )
          {
            if(Do_Rip==GOOD)Rip_P40A();
            if(Do_Depack==GOOD)Depack_P40();
          }
        }
             ...
             (in_data[PW_i+3] == 'A') )
        {
          if ( testP41A() != BAD )
          {
            if(Do_Rip==GOOD)Rip_P41A();
            if(Do_Depack==GOOD)Depack_P41A();
          }
        }
             ...
             (in_data[PW_i+3] == '3') )
        {
	      ...
	      {
            if(Do_Rip==GOOD)Rip_PMD3();
            if(Do_Depack==GOOD)Depack_PMD3();
          }
        }
             ...
             (in_data[PW_i+3] == '0') )
        {
          if ( testPM40() != BAD )
          {
            if(Do_Rip==GOOD)Rip_PM40();
            if(Do_Depack==GOOD)Depack_PM40();
          }
        }
             ...
             (in_data[PW_i+3] == 'A') )
        {
          if ( testSpecialCruncherData ( 8, 4 ) != BAD )
          {
            Current_Is_Module=BAD;if(Do_Rip==GOOD)Rip_SpecialCruncherData( "PARA Data Cruncher" , 46 , PARA );
          }
        }
             ...
             (in_data[PW_i+3] == '1') )
        {
          if ( testSpecialCruncherData ( 8, 4 ) != BAD )
          {
            Current_Is_Module=BAD;if(Do_Rip==GOOD)Rip_SpecialCruncherData( "Pac1 Data Cruncher" , 12 , Pac1 );
          }
        }
             ...
             (in_data[PW_i+7] == '2') )
        {
          if ( testSpecialCruncherData ( 12, 8 ) != BAD )
          {
            Current_Is_Module=BAD;if(Do_Rip==GOOD)Rip_SpecialCruncherData( "Master Cruncher 3.0 data" , 8 , MasterCruncher3data );
          }
        }
#endif
          /* POLKA Packer */
	     ...
	     (in_data[PW_i+3] == 'X')))
        {
          if ( testPolka() != BAD )
          {
            if(Do_Rip==GOOD)Rip_Polka();
            if(Do_Depack==GOOD)Depack_Polka();
          }
        }
             ...
             (in_data[PW_i+7] == 'G'))
        {
          if ( testPERFSONG() != BAD )
          {
            if(Do_Rip==GOOD)Rip_PERFSONG();
            if(Do_Depack==GOOD)Depack_PERFSONG();
          }
        }
        break;
      ...
      case 'R':  /* RNC */
             ...
             (in_data[PW_i+2] == 'C') )
        {
          ...
          if ( testSpecialCruncherData ( 8, 4 ) != BAD )
          {
            Current_Is_Module=BAD;if(Do_Rip==GOOD)Rip_SpecialCruncherData( "Propack (RNC) data" , 18 , RNC );
          }
        }
          /* RLE Data Cruncher */
        if ( (in_data[PW_i+1] == 'L') &&
             (in_data[PW_i+2] == 'E') )
        {
          if ( testSpecialCruncherData ( 8, 4 ) != BAD )
          {
            Current_Is_Module=BAD;if(Do_Rip==GOOD)Rip_SpecialCruncherData( "RLE Data Cruncher" , 11 , RLE );
          }
        }
#endif
        break;
      ...
      case 'S':  /* 0x53 */
             ...
             (in_data[PW_i+3] == '0') )
        {
          ...
          {
            Current_Is_Module=BAD;if(Do_Rip==GOOD)Rip_SpecialCruncherData( "SpeedPacker (SP20) Data Cruncher" , 16 , SP20 );
          }
        }
#endif
          /* "SNT!" ProRunner 2 */
             ...
             (in_data[PW_i+3] == '!') )
        {
          if ( testPRUN2() != BAD )
          {
            if(Do_Rip==GOOD)Rip_PRUN2();
            if(Do_Depack==GOOD)Depack_PRUN2();
          }
        }
          /* "SNT." ProRunner 1 */
        if ( (in_data[PW_i+1] == 'N') &&
             ...
             (in_data[PW_i+3] == '.') )
        {
          if ( testPRUN1() != BAD )
          {
            if(Do_Rip==GOOD)Rip_PRUN1();
            if(Do_Depack==GOOD)Depack_PRUN1();
          }
        }
             ...
             (in_data[PW_i+3] == 'T') )
        {
          if ( testSKYT() != BAD )
          {
            if(Do_Rip==GOOD)Rip_SKYT();
            if(Do_Depack==GOOD)Depack_SKYT();
          }
        }
...
/*        if ( (in_data[PW_i+1] == 'I') &&
             ...
             (in_data[PW_i+3] == '4') )
        {
          if ( testSpecialCruncherData ( 12, 8 ) != BAD )
          {
            Current_Is_Module=BAD;if(Do_Rip==GOOD)Rip_SpecialCruncherData( "StoneCracker 4.04 data" , 18 , S404 );
          }
        }
             ...
             (in_data[PW_i+3] == '3') )
        {
          if ( testSpecialCruncherData ( 12, 8 ) != BAD )
          {
            Current_Is_Module=BAD;if(Do_Rip==GOOD)Rip_SpecialCruncherData( "StoneCracker 4.03 data" , 20 , S404 );
          }
        }
             ...
             (in_data[PW_i+3] == '1') )
        {
          if ( testSpecialCruncherData ( 8, 4 ) != BAD )
          {
            Current_Is_Module=BAD;if(Do_Rip==GOOD)Rip_SpecialCruncherData( "StoneCracker 4.01 data" , 12 , S404 );
          }
        }
             ...
             (in_data[PW_i+3] == '0') )
        {
          if ( testSpecialCruncherData ( 8, 4 ) != BAD )
          {
            Current_Is_Module=BAD;if(Do_Rip==GOOD)Rip_SpecialCruncherData( "StoneCracker 4.00 data" , 12 , S404 );
          }
        }
             ...
             (in_data[PW_i+3] == '0') )
        {
          if ( testSpecialCruncherData ( 8, 4 ) != BAD )
          {
            Current_Is_Module=BAD;if(Do_Rip==GOOD)Rip_SpecialCruncherData( "StoneCracker 3.10 data" , 16 , S404 );
          }
        }
             ...
             (in_data[PW_i+3] == '0') )
        {
          if ( testSpecialCruncherData ( 12, 8 ) != BAD )
          {
            Current_Is_Module=BAD;if(Do_Rip==GOOD)Rip_SpecialCruncherData( "StoneCracker 3.00 data" , 16 , S404 );
          }
        }
...
/*        if ( (in_data[PW_i+1] == 'A') )
        {
          if ( testSpecialCruncherData ( 10, 6 ) == BAD )
            break;
          Current_Is_Module=BAD;if(Do_Rip==GOOD)Rip_SpecialCruncherData( "SA Data Cruncher" , 182 , SF );
          break;
        }*/
...
/*        if ( (in_data[PW_i+1] == 'C') )
        {
          if ( testSpecialCruncherData ( 8, 4 ) == BAD )
            break;
          Current_Is_Module=BAD;if(Do_Rip==GOOD)Rip_SpecialCruncherData( "SC Data Cruncher" , 76 , SF );
          break;
        }*/
...
/*        if ( (in_data[PW_i+1] == 'F') )
        {
          if ( testSpecialCruncherData ( 6, 2 ) == BAD )
            break;
          Current_Is_Module=BAD;if(Do_Rip==GOOD)Rip_SpecialCruncherData( "SF Data Cruncher" , 11 , SF );
          break;
        }*/
...
/*	    if ( (in_data[PW_i+1] == 'Q') )
        {
          if ( testSpecialCruncherData ( 6, 2 ) == BAD )
            break;
          Current_Is_Module=BAD;if(Do_Rip==GOOD)Rip_SpecialCruncherData( "SQ Data Cruncher" , 999991 , SQ );
          break;
	    }*/
...
/*        if ( (in_data[PW_i+1] == 'P') )
        {
          if ( testSpecialCruncherData ( 8, 4 ) == BAD )
            break;
          Current_Is_Module=BAD;if(Do_Rip==GOOD)Rip_SpecialCruncherData( "SP Data Cruncher" , 12 , SP );
          break;
	    }*/
#endif
          /* STIM Slamtilt */
             ...
             (in_data[PW_i+3] == 'M') )
        {
          if ( testSTIM() != BAD )
          {
            if(Do_Rip==GOOD)Rip_STIM();
            if(Do_Depack==GOOD)Depack_STIM();
          }
        }
	  ...
	  /* SPv3 - Speed Packer 3 (Atari ST) */
             ...
             (in_data[PW_i+3] == '3') )
        {
          if ( testSpecialCruncherData ( 8, 12 ) != BAD )
          {
            Current_Is_Module=BAD;if(Do_Rip==GOOD)Rip_SpecialCruncherData( "Speed Packer 3 data" , 0 , SpeedPacker3Data );
          }
        }
#endif
          /* SONG Fuchs Tracker */
             ...
             (in_data[PW_i+3] == 'G') )
        {
          ...
          {
            if(Do_Rip==GOOD)Rip_FuchsTracker();
            if(Do_Depack==GOOD)Depack_FuchsTracker();
          }
          /* Sound FX */
          if ( testSoundFX13() != BAD )
          {
            if(Do_Rip==GOOD)Rip_SoundFX13();
#ifndef UNIX
            if(Do_Depack==GOOD)Depack_SoundFX13();
#endif
          }
        }
        break;
	  ...
	  /* "TMK. Timetracker ?!? */
             ...
             ( in_data[PW_i+3] == 0x01 ) )
        {
          if ( testTMK() != BAD )
          {
            if(Do_Rip==GOOD)Rip_TMK();
            if(Do_Depack==GOOD)Depack_TMK();
          }
        }
        break;
	...
	/* Mugician */
      ...
      case 'V': /* "V.2" */
             ...
             (in_data[PW_i+3] == 'O') )
        {
          if ( testSpecialCruncherData ( 12, 8 ) != BAD )
          {
            Current_Is_Module=BAD;if(Do_Rip==GOOD)Rip_SpecialCruncherData( "Virtual Dreams (VDCO) data cruncher" , 13 , VDCO );
          }
        }
#endif
        break;
      ...
      case 'W': /* 0x57 */
             ...
             (in_data[PW_i+2] == 0x00 ) )
        {
          if ( testWN() != BAD )
          {
            if(Do_Rip==GOOD)Rip_WN();
            if(Do_Depack==GOOD)Depack_WN();
          }
        }
        break;
      ...
      case 'X': /* XPKF */
             ...
             (in_data[PW_i+3] == 'F') )
        {
          ...
          {
            Current_Is_Module=BAD;if(Do_Rip==GOOD)Rip_SpecialCruncherData( "XPK" , 8 , XPK );
          }
        }
#endif
        break;
      ...
      case 0x60:
             ...
             (in_data[PW_i+15]== 0xe7) )   /* gosh !, should be enough :) */
        {
          if ( testPMZ() != BAD )
          {
            if(Do_Rip==GOOD)Rip_PM18a();
            if(Do_Depack==GOOD)Depack_PM18a();
          }

          /* Promizer 1.0c */
          if ( testPM10c() != BAD )
          {
            if(Do_Rip==GOOD)Rip_PM10c();
            if(Do_Depack==GOOD)Depack_PM10c();
          }
        }
             ...
             (in_data[PW_i+15]== 0x3a) )   /* gosh !, should be enough :) */
        {
          if ( testPM2() != BAD )
          {
            if(Do_Rip==GOOD)Rip_PM20();
            if(Do_Depack==GOOD)Depack_PM20();
          }
        }
             ...
             (in_data[PW_i+37] == 0x8B) )
        {
          ...
          {
            if(Do_Rip==GOOD)Rip_SpikeCruncher();
          }
        }
#endif
        break;
      ...
      case 0x61: /* "a" */
             ...
             (in_data[PW_i+15] == 0x04) )
        {
          ...
          {
            Current_Is_Module=BAD;if(Do_Rip==GOOD)Rip_TNMCruncher11();
          }
        }
             ...
             (in_data[PW_i+13] == 0xFC) )
        {
          ...
          {
            if(Do_Rip==GOOD)Rip_Tetrapack_2_1();
          }
        }
             ...
             (in_data[PW_i+13] == 0x7A) )
        {
          if ( testTetrapack_2_2() != BAD )
            if(Do_Rip==GOOD)Rip_Tetrapack_2_2();
        }
             ...
             (in_data[PW_i+20] == 0x61))
        {
          ...
          {
            Current_Is_Module=BAD;if(Do_Rip==GOOD)Rip_HighPressureCruncher();
          }
        }
#endif
        break;
      ...
      case 'x': /* xVdg */
             ...
             (in_data[PW_i+3] == 'g') )
        {
          if ( testSpecialCruncherData ( 8, 4 ) != BAD )
          {
            Current_Is_Module=BAD;if(Do_Rip==GOOD)Rip_SpecialCruncherData( "xVdg" , 12 , xVdg );
          }
        }
#endif
        break;
...
/*     if ( (in_data[PW_i+1] == 0x00) &&
      ...
      case 0xAC:
        ...
        if ( in_data[PW_i+1] == 0x1D )
        {
          if ( testAC1D() != BAD )
          {
            if(Do_Rip==GOOD)Rip_AC1D();
            if(Do_Depack==GOOD)Depack_AC1D();
          }
        }
        break;
      ...
      case 0xB4:
             ...
             (in_data[PW_i+8]  == 0x53) ) ) )
        {
          ...
          {
            Current_Is_Module=BAD;if(Do_Rip==GOOD)Rip_DietDataPacker();
          }
        }
#endif
        break;
      ...
      case 0xC0:
        ...
        if ( (PW_i >= 1) && (in_data[PW_i-1] == 0x03) )
        {
          if ( testPHA() != BAD )
          {
            if(Do_Rip==GOOD)Rip_PHA();
            if(Do_Depack==GOOD)Depack_PHA();
          }
        }
        break;
