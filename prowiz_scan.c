/*
 * prowiz_scan.c — scan engine (library code)
 *
 * Extracted from prowiz.c — contains PW_ScanData() which is the core
 * format-detection engine shared by both CLI and library API.
 */
